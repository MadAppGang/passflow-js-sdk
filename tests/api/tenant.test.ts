    ...
    mockAxiosInstance.request.mockImplementation(
      (config: {
        ...
        // Group Management
          ...
          config.url === `${PassflowEndpointPaths.tenantPath}/${mockTenantId}/group/${mockGroupId}/add` &&
          config.method === 'post'
        ) {
          responseData = mockStatusResponse;
        } else if (
          config.url === `${PassflowEndpointPaths.tenantPath}/${mockTenantId}/group/${mockGroupId}/remove_roles` &&
          config.method === 'post'
        ) {
          responseData = mockStatusResponse;
        } else if (
          config.url === `${PassflowEndpointPaths.tenantPath}/${mockTenantId}/group/${mockGroupId}/change` &&
          config.method === 'post'
        ) {
          responseData = mockStatusResponse;
        } else if (
          config.url === `${PassflowEndpointPaths.tenantPath}/${mockTenantId}/group/${mockGroupId}/${mockUserId}` &&
        ...
        // User Management in Tenants
          ...
          config.url === `${PassflowEndpointPaths.tenantPath}/${mockTenantId}/user/${mockUserId}` &&
          config.method === 'delete'
        ) {
          responseData = mockStatusResponse;
        }
        // Invitation Management
          ...
          config.url === `${PassflowEndpointPaths.tenantPath}/${mockTenantId}/group/${mockGroupId}/invitations` &&
          config.method === 'get'
        ) {
          responseData = mockInvitationsResponse;
        } else if (
          config.url === `${PassflowEndpointPaths.tenantPath}/${mockTenantId}/invitations` &&
          config.method === 'get'
        ) {
          responseData = mockInvitationsResponse;
        } else if (
          config.url === `${PassflowEndpointPaths.tenantPath}/${mockTenantId}/group/${mockGroupId}/invite/${mockInviteId}` &&
          config.method === 'delete'
        ) {
          responseData = {};
        } else if (
          config.url === `${PassflowEndpointPaths.tenantPath}/${mockTenantId}/group/${mockGroupId}/invite/email/${mockEmail}` &&
          config.method === 'delete'
        ) {
          responseData = {};
        }
